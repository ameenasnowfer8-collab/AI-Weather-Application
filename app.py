...
st.set_page_config(
    page_title="Weather Buddy AI",
    page_icon="🌤️",
    layout="centered"
)

st.title("🌤️ Weather Buddy AI")
st.caption("AI Weather Assistant using Function Calling")

HF_TOKEN = os.getenv("HF_TOKEN")

if not HF_TOKEN:
    st.error("HF_TOKEN is not configured.")
    st.info("Please create a .env file and add your Hugging Face token.")
    st.stop()
    ...
    messages = [
        {
            ...
            "content": (
                ...
                "Always report temperature in °C, humidity in %, "
